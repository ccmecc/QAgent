# From https://github.com/linkedin/Liger-Kernel/blob/main/src/liger_kernel/ops/grpo_loss.py
import torch
import triton
...
# From https://github.com/linkedin/Liger-Kernel/blob/main/src/liger_kernel/transformers/grpo_loss.py#L47
